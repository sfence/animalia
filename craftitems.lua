...
minetest.register_craftitem("hades_animalia:venison_raw", {
...
minetest.register_craftitem("hades_animalia:venison_raw_cooked", {
...
minetest.register_craft({
	type  =  "cooking",
	recipe  = "hades_animalia:venison_raw",
	output = "hades_animalia:venison_cooked",
})

register_egg("hades_animalia:chicken_egg", {
	description = "Chicken Egg",
	inventory_image = "animalia_egg",
	mob = "hades_animalia:chicken"
})

register_egg("hades_animalia:turkey_egg", {
	description = "Turkey Egg",
	inventory_image = "animalia_egg",
	mob = "hades_animalia:turkey"
})
...
minetest.register_craftitem("hades_animalia:bucket_guano", {
		...
		if pos then
			...
			and not minetest.is_protected(pos, placer:get_player_name()) then
				if guano_fert then
					...
					minetest.set_node(pos, {name = "hades_animalia:guano"})
					local replace = itemstack:get_meta():get_string("original_item")
					if not replace
					or replace == "" then
						replace = "bucket:bucket_empty"
...
minetest.register_node("hades_animalia:nest_song_bird", {
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	if formname == "hades_animalia:set_name" and fields.name then
...
local function nametag_rightclick(itemstack, player, pointed_thing)
	...
	local meta = itemstack:get_meta()
	minetest.show_formspec(name, "hades_animalia:set_name", get_rename_formspec(meta))
end

minetest.register_craftitem("hades_animalia:nametag", {
	description = "Nametag",
...
minetest.register_node("hades_animalia:guano", {
	description = "Guano",
	...
	on_punch = function(pos, _, player)
		...
		and item_name:find("empty") then
			local stack = ItemStack("hades_animalia:bucket_guano")
...
function animalia.show_libri_main_form(player, pages, group)
	...
	minetest.show_formspec(player:get_player_name(), "hades_animalia:libri_main", basic_form)
end

minetest.register_craftitem("hades_animalia:libri_animalia", {
...
minetest.register_craft({
	output = "hades_animalia:libri_animalia",
	recipe = {
		{"", "", ""},
		{"hades_animalia:feather", "", ""},
...
minetest.register_craft({
	output = "hades_animalia:libri_animalia 2",
	recipe = {
		{"", "", ""},
		{"hades_animalia:libri_animalia", "group:book", ""},
		{"", "", ""}
	}
})

minetest.register_on_craft(function(itemstack, _, old_craft_grid)
	if itemstack:get_name() == "hades_animalia:libri_animalia"
