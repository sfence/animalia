...
creatura.register_mob_spawn("hades_animalia:bat", {
	chance = 2,
	min_radius = 4,
	max_radius = 16,
	min_light = 0,
...
creatura.register_mob_spawn("hades_animalia:chicken", {
	chance = 3,
	min_group = 3,
	max_group = 5,
...
creatura.register_mob_spawn("hades_animalia:cow", {
	chance = 3,
	min_group = 3,
	max_group = 4,
...
creatura.register_mob_spawn("hades_animalia:frog", {
	chance = 2,
	min_radius = 4,
	max_radius = 16,
	min_light = 0,
...
creatura.register_mob_spawn("hades_animalia:horse", {
	chance = 3,
	min_group = 4,
	max_group = 5,
	biomes = animalia.registered_biome_groups["grassland"].biomes
...
creatura.register_mob_spawn("hades_animalia:pig", {
	chance = 3,
	min_group = 2,
	max_group = 4,
	biomes = pig_biomes
...
creatura.register_mob_spawn("hades_animalia:reindeer", {
	chance = 4,
	min_group = 6,
	max_group = 12,
...
creatura.register_mob_spawn("hades_animalia:sheep", {
	chance = 3,
	min_group = 3,
	max_group = 6,
	biomes = animalia.registered_biome_groups["grassland"].biomes
...
creatura.register_mob_spawn("hades_animalia:turkey", {
	chance = 2,
	min_group = 3,
	max_group = 4,
	biomes = animalia.registered_biome_groups["boreal"].biomes
...
creatura.register_mob_spawn("hades_animalia:wolf", {
	chance = 3,
	min_group = 2,
	max_group = 3,
	biomes = animalia.registered_biome_groups["boreal"].biomes
...
creatura.register_mob_spawn("hades_animalia:bird", {
	chance = 1,
	min_light = 0,
	min_group = 12,
	max_group = 16,
...
creatura.register_on_spawn("hades_animalia:bird", function(self, pos)
	local node = minetest.get_node(pos)
	if node.name == "air" then
		minetest.set_node(pos, {name = "hades_animalia:nest_song_bird"})
		...
		if nodes[1] then
			pos = nodes[1]
			minetest.set_node({x = pos.x, y = pos.y + 1, z = pos.z}, {name = "hades_animalia:nest_song_bird"})
...
creatura.register_mob_spawn("hades_animalia:tropical_fish", {
	chance = 3,
	min_height = -128,
	max_height = 256,
	min_group = 8,
					...
					and #spawnable_mobs > 0 then
						...
						if #objects > 0 then
							for _, object in ipairs(objects) do
								...
								if ent
								and ent.name:find("hades_animalia:") then
									spawn = false
									break
								end
							end
