...
creatura.register_movement_method("hades_animalia:fly_simple", function(self)
...
creatura.register_movement_method("hades_animalia:swim_simple", function(self)
	local box = clamp(self.width, 0.5, 1.5)
	local steer_to
	local steer_timer = 0.25
	self:set_gravity(0)
...
creatura.register_utility("hades_animalia:die", function(self)
	local timer = 1.5
	local init = false
	local function func(_self)
		if not init then
...
creatura.register_utility("hades_animalia:swim_to_land", function(self)
	local init = false
	local tpos = nil
	local function func(_self)
		if not init then
...
creatura.register_utility("hades_animalia:wander", function(self)
	local move_chance = 5
...
creatura.register_utility("hades_animalia:wander_group", function(self)
	local move_chance = 3
...
creatura.register_utility("hades_animalia:wander_skittish", function(self)
	local move_chance = 3
	local idle_duration = 3
	local center = self.object:get_pos()
	if not center then return end
...
creatura.register_utility("hades_animalia:aerial_wander", function(self)
	local center = self.object:get_pos()
	if not center then return end
	local height_tick = 0
	local function func(_self)
		...
		if not _self:get_action() then
			...
			animalia.action_move_flock(_self, pos2, 3, "hades_animalia:fly_simple", 1, "fly")
		end
	end
	self:set_utility(func)
end)

creatura.register_utility("hades_animalia:fly_to_roost", function(self)
	...
	local function func(_self)
		...
		if not _self:get_action() then
			...
			creatura.action_move(_self, home, 3, "hades_animalia:fly_simple", 1, "fly")
		end
	end
	self:set_utility(func)
end)

creatura.register_utility("hades_animalia:fly_to_land", function(self)
	local landed = false
	local function func(_self)
		if not _self:get_action() then
			...
			if _self.touching_ground then
				...
				if pos2 then
					...
					creatura.action_move(_self, pos2, 3, "hades_animalia:fly_simple", 0.6, "fly")
				end
			end
		end
	end
...
creatura.register_utility("hades_animalia:aquatic_wander_school", function(self)
	local center = self.object:get_pos()
	if not center then return end
	local center_tick = 0
	...
	local function func(_self)
		...
		if not _self:get_action() then
			animalia.action_move_flock(_self, water_nodes[random(#water_nodes)], 3, "hades_animalia:swim_simple", 1, "swim")
		end
	end
	self:set_utility(func)
end)

creatura.register_utility("hades_animalia:aquatic_wander", function(self)
	local center = self.object:get_pos()
	if not center then return end
	local center_tick = 0
	local move_chance = 3
	...
	local function func(_self)
		...
		if not _self:get_action() then
			if random(move_chance) < 2 then
				creatura.action_move(_self, water_nodes[random(#water_nodes)], 3, "hades_animalia:swim_simple", 0.5, "swim")
			else
...
creatura.register_utility("hades_animalia:eat_turf", function(self)
...
creatura.register_utility("hades_animalia:eat_bug", function(self, bug)
	local timer = 0.2
	local action_init = false
	local function func(_self)
		local pos = _self.object:get_pos()
...
creatura.register_utility("hades_animalia:run_to_pos", function(self, pos2, timeout)
...
creatura.register_utility("hades_animalia:follow_player", function(self, player, force)
...
creatura.register_utility("hades_animalia:flee_from_target", function(self, target)
	local los_timeout = 3
	local function func(_self)
		local pos = _self.object:get_pos()
		if not pos then return end
...
creatura.register_utility("hades_animalia:flee_from_target_defend", function(self, target)
	local los_timeout = 3
	local function func(_self)
		local pos = _self.object:get_pos()
		if not pos then return end
...
creatura.register_utility("hades_animalia:tame_horse", function(self)
	local center = self.object:get_pos()
	local trust = 5
	local function func(_self)
		local pos = _self.object:get_pos()
...
creatura.register_utility("hades_animalia:attack_target", function(self, target)
	local width = self.width
	local punch_init = false
	local function func(_self)
		local pos = _self.object:get_pos()
...
creatura.register_utility("hades_animalia:breed", function(self)
...
creatura.register_utility("hades_animalia:stay", function(self)
	local function func(_self)
...
creatura.register_utility("hades_animalia:destroy_nearby_vessel", function(self)
	local width = self.width
	local timeout = 8
	local nodes
...
creatura.register_utility("hades_animalia:play_with_player", function(self, player)
...
creatura.register_utility("hades_animalia:bother_player", function(self, player)
	local width = self.width
	local play_init = false
	local timeout = 5
	local function func(_self)
...
creatura.register_utility("hades_animalia:mount_horse", function(self, player)
...
creatura.register_utility("hades_animalia:flop", function(self)
	local function func(_self)
