...
function animalia.set_nametag(self, clicker)
	...
	if item
	and item:get_name() ~= "hades_animalia:nametag" then
		return
	end
...
local spawn_biomes = {
	["hades_animalia:bat"] = "cave",
	["hades_animalia:bird"] = "temperate",
	["hades_animalia:cat"] = "urban",
	["hades_animalia:chicken"] = "tropical",
	["hades_animalia:cow"] = "grassland",
	["hades_animalia:tropical_fish"] = "ocean",
	["hades_animalia:frog"] = "swamp",
	["hades_animalia:horse"] = "grassland",
	["hades_animalia:pig"] = "temperate",
	["hades_animalia:reindeer"] = "boreal",
	["hades_animalia:sheep"] = "grassland",
	["hades_animalia:turkey"] = "boreal",
	["hades_animalia:wolf"] = "boreal",
}
...
function animalia.get_libri(inventory)
	...
	for i = 1, inventory:get_size("main") do
		local stack = list[i]
		if stack:get_name()
		and stack:get_name() == "hades_animalia:libri_animalia" then
			return stack, i
		end
	end
end
...
function animalia.add_libri_page(self, player, page)
	...
	if contains_item(inv, "hades_animalia:libri_animalia") then
...
local function update_libri(player_name, mob_name)
	...
	minetest.show_formspec(player_name, "hades_animalia:libri_" .. mob_name:split(":")[2], get_libri_page(mob_name, player_name))
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
	...
	if formname == "hades_animalia:libri_main" then
		animalia_libri_info[player_name] = {}
	...
	if formname:match("^hades_animalia:libri_") then
