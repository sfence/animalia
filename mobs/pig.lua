...
creatura.register_mob("hades_animalia:pig", {
    -- Stats
    max_health = 10,
    ...
    drops = {
        {name = "hades_animalia:porkchop_raw", min = 1, max = 3, chance = 1}
    },
    follow = follows,
    -- Function
	utility_stack = {
		...
		[2] = {
			utility = "hades_animalia:eat_from_turf",
			step_delay = 0.25,
			get_score = function(self)
...
creatura.register_spawn_egg("hades_animalia:pig", "e0b1a7" ,"cc9485")
