...
creatura.register_mob("hades_animalia:tropical_fish", {
    -- Stats
    max_health = 5,
	...
	utility_stack = {
		{
			utility = "hades_animalia:aquatic_wander_school",
			step_delay = 0.25,
...
creatura.register_spawn_egg("hades_animalia:tropical_fish", "e28821", "f6e5d2")

animalia.alias_mob("hades_animalia:clownfish", "hades_animalia:tropical_fish")
animalia.alias_mob("hades_animalia:blue_tang", "hades_animalia:tropical_fish")
animalia.alias_mob("hades_animalia:angelfish", "hades_animalia:tropical_fish")
