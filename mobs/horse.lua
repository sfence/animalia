...
creatura.register_mob("hades_animalia:horse", {
    -- Stats
    max_health = 40,
    ...
    drops = {
		{name = "hades_animalia:leather", min = 1, max = 4, chance = 2}
    },
    follow = follows,
	consumable_nodes = {
	...
	utility_stack = {
		...
		{
			utility = "hades_animalia:flee_from_target_defend",
			get_score = function(self)
		...
		{
			utility = "hades_animalia:tame_horse",
			get_score = function(self)
		...
		{
			utility = "hades_animalia:mount_horse",
			get_score = function(self)
	...
	on_rightclick = function(self, clicker)
        ...
        and self.owner == clicker:get_player_name() then
			...
			and tool_name == "" then
				...
				self:initiate_utility("hades_animalia:mount", self, clicker)
			elseif tool_name == "hades_animalia:saddle" then
...
creatura.register_spawn_egg("hades_animalia:horse", "ebdfd8" ,"653818")
