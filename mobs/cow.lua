...
creatura.register_mob("hades_animalia:cow", {
    -- Stats
    max_health = 20,
    ...
    drops = {
        {name = "hades_animalia:beef_raw", min = 1, max = 3, chance = 1},
		{name = "hades_animalia:leather", min = 1, max = 3, chance = 2}
    },
    follow = follows,
	consumable_nodes = {
...
creatura.register_spawn_egg("hades_animalia:cow", "cac3a1" ,"464438")
