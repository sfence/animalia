...
creatura.register_mob("hades_animalia:reindeer", {
    -- Stats
    max_health = 20,
    ...
    drops = {
        {name = "hades_animalia:venison_raw", min = 1, max = 3, chance = 1},
...
creatura.register_spawn_egg("hades_animalia:reindeer", "cac3a1" ,"464438")
